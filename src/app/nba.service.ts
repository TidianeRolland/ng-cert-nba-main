...
export class NbaService {
  ...
  private readonly DEFAULT_NUMBER_OF_DAYS = 12;
  numberOfDaysSub = new BehaviorSubject<number>(this.DEFAULT_NUMBER_OF_DAYS);
  numberOfDays$ = this.numberOfDaysSub.asObservable().pipe(shareReplay(1));
  ...
  onSelectNumberOfDays(value: number) {
    this.numberOfDaysSub.next(value);
  }
